...
/**
 * Defines a read from channel statement (?). Needs type checking added
 * @author Steve "Uru" West <sw349@kent.ac.uk>
 * @version 2012-03-03
 */
public class ChannelRead extends CodeBlock {
    ...
    public ChannelRead(){
        ...
        chan = new ChannelEnd(Type.GENERIC, EndType.READ, null);
        chan.setParent(this);
        chan.setName("");
    }
    ...
    public void draw(Graphics g){
        ...
        g.setColor(new Color(173, 255, 168));
