...
/**
 * Defines the >= (greater than or equals) operator
 * @author Steve "Uru" West <sw349@kent.ac.uk>
 * @version 2011-12-12
 */
public class GreaterThanEqual extends CodeBlock {
     ...
     * @param rightSide 
     */
    public GreaterThanEqual(CodeBlock leftSide, CodeBlock rightSide) {
    ...
    public CodeBlock clone() {
        return new GreaterThanEqual(getLeftSide().clone(), getRightSide().clone());
    }
