 ...
 * @version 2011-12-12
 */
public class GreaterThan extends CodeBlock {
     ...
     * @param rightSide 
     */
    public GreaterThan(CodeBlock leftSide, CodeBlock rightSide) {
    ...
    public CodeBlock clone() {
        return new GreaterThan(getLeftSide().clone(), getRightSide().clone());
    }
