...
/**
 * Defines an AND statement
 * @author Steve "Uru" West <sw349@kent.ac.uk>
 * @version 2011-12-12
 */
public class AND extends CodeBlock {

    private CodeBlock leftBranch;
    private CodeBlock rightBranch;

    public AND(CodeBlock leftBranch, CodeBlock rightBranch) {
    ...
    public CodeBlock clone() {
        return new AND(leftBranch.clone(), rightBranch.clone());
    }

    @Override
    public String toString() {
        return "(" + leftBranch.toString() + " AND " + rightBranch.toString() + ")";
    }
